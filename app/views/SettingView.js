...
export default class SettingView extends Component{
           ...
           <Container>
               <Header>
                   <Left><Button transparent onPress={() => this.props.navigation.goBack()}><Icon
                       name='arrow-back' style={{color: '#959595',}}/></Button></Left>
                   <Body><Text>设置</Text></Body>
                   <Right></Right>
               </Header>
               <Content>
    ...
    _renderSettingItem(){
        let _data = [
            ...
            {name:"蓝",bgDefaultColor:"#3698da",bgActiveColor:"#24a6f2",fontDefaultColor:"#000",fontActiveColor:"#f37836"},
            ...
            return (
                <View>
                    ...
                    {_data.map((val,idx) => {
                        return (<View key={`${idx}`} style={[styles.settingItem,{backgroundColor:val.bgDefaultColor}]}>
